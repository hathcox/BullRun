...
{
    // Penny: $0.50-$5, High volatility, 1 stock/round (FIX-5)
    ...
    // Low-Value: $5-$50, Moderate-high volatility, 1 stock/round (FIX-5)
    ...
    // Mid-Value: $50-$500, Medium volatility, 1 stock/round (FIX-5)
    ...
    // Blue Chip: $500-$5000, Lower volatility, 1 stock/round (FIX-5)
