...
/// Story 17.2: 23 balanced relics replacing 8 placeholders. Costs range 8-50 Rep.
/// </summary>
public static class ShopItemDefinitions
{
    /// <summary>
    /// 23 relic definitions with balanced costs (8-50 Rep). Uniform random selection.
